...
<div class="lists-form">
    ...
    <?= $form->field($model, 'report')->textInput(['maxlength' => '150'])->label(Yii::t('app','Report Name')); ?>
    <?= $form->field($model, 'shortdesc')->textarea(['maxlength' => '350'])->label(Yii::t('app','Short Descriptions')); ?>
    <?php
    echo $form->field($model, 'report_type')->radioList(array('profile'=>'Profile','list'=>'Listing'))->label(Yii::t('app','Report Type')) ;
            //echo '</div>';
    ?>
