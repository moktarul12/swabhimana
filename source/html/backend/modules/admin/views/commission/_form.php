...
/* @var $model backend\models\Commission */
...
<div class="commission-form">
    ...
    <div class="form-group">
        <?= Html::submitButton($model->isNewRecord ? Yii::t('app','Create') : Yii::t('app','Update'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary','onclick' => 'return commissionValidate();']) ?>
    </div>
