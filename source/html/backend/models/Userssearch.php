...
class Userssearch extends Users
{
    ...
    public function searchdeletedusers($params)
    {
        $query = Users::find();
        ...
        // $query->andWhere(['<>','user_level','god']);
        $query->andWhere(['=','userstatus','4']);
        $query->andWhere(['=','accountstatus','deleted']);
        $query->andFilterWhere([
            'id' => $this->id,
            'verify_pass' => $this->verify_pass,
            'verify_passcode' => $this->verify_passcode,
    ...
    public function searchdeletedhosts($params)
    {
        $query = Users::find();
