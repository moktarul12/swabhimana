...
$this->title = 'Deleted User Management';
$this->params['subtitle'] = ''. Yii::t('app','Deleted User Management').'';
		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h2>'. Yii::t('app','Manage Deleted Users').'</h2>
    ...
    <?= GridView::widget([
      ...
      [
			...
			[
				...
				'format' => 'raw',
				'value' =>function ($model) {
							return '<input type="button" class="btn btn-success" value="'. Yii::t('app','Restore').'" onclick="changeuserstatus(\'unblock\','.$model->id.')">
