...
$this->title = 'Blocked User Management';
$this->params['subtitle'] = ''. Yii::t('app','Blocked User Management').'';
    ...
    <?= GridView::widget([
      ...
      [
			...
			[
				...
				'format' => 'raw',
				'value' =>function ($model) {
							return '<input type="button" class="btn btn-success" value="'. Yii::t('app','Unblock').'" onclick="changeuserstatus(\'unblock\','.$model->id.')">
