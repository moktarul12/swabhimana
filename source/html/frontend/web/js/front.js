        ...
        $.ajax({
            ...
            success: function (e) {
                $("#showBasi").css("background", "none"),
                    ...
                    $("#showDesc").css("border-left", "3px solid #0EBCF7"),
...
function show_basics() {
    $("#showBasi").css("background", "#ddd"), $("#showDesc").css("background", "none"), $("#showBasi").css("border-left", "solid 3px #0EBCF7"), $("#showDesc").css("border-left", ""), $("#basicsdiv").show(), $("#descriptiondiv").hide();
}
    ...
    $.ajax({
        ...
        success: function (e) {
            $("#showDesc").css("background", "none"),
                ...
                $("#showLoc").css("border-left", "solid 3px #0EBCF7"),
                ...
                : $.ajax({
                      ...
                      success: function (e) {
                          $("#showLoc").css("background", "none"),
                              ...
                              $("#showAmenities").css("border-left", "3px solid #0EBCF7"),
    ...
    $.ajax({
        ...
        success: function (e) {
            $("#showAmenities").css("background", "none"),
                ...
                $("#showPhoto").css("border-left", "solid 3px #0EBCF7"),
                $("#showAmenities").css("border-left", ""),
                $("#amenitiesdiv").hide(),
                $("#photosdiv").show(),
                $(window).scrollTop(0);
    ...
    $.ajax({
        ...
        success: function (e) {
            $("#showPhoto").css("background", "none"),
                ...
                $("#showHomesafe").css("border-left", "solid 3px #0EBCF7"),
...
function show_backamenities() {
    $("#showPhoto").css("background", "none"),
        $("#showAmenities").css("background", "#ddd"),
        $("#showAmenities").css("border-left", "solid 3px #0EBCF7"),
        $("#showPhoto").css("border-left", ""),
        $("#photosdiv").hide(),
        $("#amenitiesdiv").show(),
        $(window).scrollTop(0);
    ...
    $.ajax({
        ...
        success: function (e) {
            $("#showHomesafe").css("background", "none"),
                ...
                $("#showPricing").css("border-left", "solid 3px #0EBCF7"),
    ...
    $.ajax({
        ...
        success: function (e) {
            $("#showPricing").css("background", "none"),
                ...
                $("#showBooking").css("border-left", "solid 3px #0EBCF7"),
        ...
        $.ajax({
            ...
            success: function (e) {
                $("#showBooking").css("background", "none"),
                    ...
                    $("#showCalendar").css("border-left", "3px solid #0EBCF7"),
...
function show_backprice() {
    $("#showBooking").css("background", "none"),
        $("#showPricing").css("background", "#ddd"),
        $("#showPricing").css("border-left", "3px solid #0EBCF7"),
        $("#showBooking").css("border-left", ""),
        $("#bookingdiv").hide(),
        $("#pricediv").show();
}
    ...
    (disp = $("#bookavailability").css("display")),
        "none" == disp
            ...
            : ($("#showBooking").css("background", "#ddd"),
              ...
              $("#showBooking").css("border-left", "3px solid #0EBCF7"),
...
function show_basics_div(e) {
    $(".commcls").hide(),
        ...
        $("#showBasi").css("border-left", "3px solid #0EBCF7"),
        $("#showDesc").css("border-left", ""),
        $("#showLoc").css("border-left", ""),
        $("#showAmenities").css("border-left", ""),
        $("#showPhoto").css("border-left", ""),
...
function show_location_div(e) {
    $(".commcls").hide(),
        $("#locationdiv").show(),
        $("#listpropul").find("li").css("background", "none"),
        $("#showLoc").css("border-left", "3px solid #0EBCF7"),
        $("#showBasi").css("border-left", ""),
        $("#showDesc").css("border-left", ""),
        $("#showCalendar").css("border-left", ""),
        $("#showAmenities").css("border-left", ""),
...
function show_photos_div(e) {
    $(".commcls").hide(),
        $("#photosdiv").show(),
        $("#listpropul").find("li").css("background", "none"),
        $("#showPhoto").css("border-left", "3px solid #0EBCF7"),
        $("#showBasi").css("border-left", ""),
        $("#showDesc").css("border-left", ""),
        $("#showLoc").css("border-left", ""),
        $("#showAmenities").css("border-left", ""),
...
function show_homesafety_div(e) {
    $(".commcls").hide(),
        $("#safetydiv").show(),
        $("#listpropul").find("li").css("background", "none"),
        $("#showHomesafe").css("border-left", "3px solid #0EBCF7"),
        $("#showBasi").css("border-left", ""),
        $("#showDesc").css("border-left", ""),
        $("#showLoc").css("border-left", ""),
        $("#showAmenities").css("border-left", ""),
