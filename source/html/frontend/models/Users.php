...
class Users extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['verify_pass', 'verify_passcode', 'country', 'created_at', 'modified_at', 'last_login', 'facebookid', 'activation', 'phoneno', 'emergencyno', 'shippingid', 'loginnotify', 'mobileverify', 'emailverify', 'reservationrequirement', 'currency_mobile'], 'integer'],
            [['verify_passcode', 'emergencyname', 'emergencyemail', 'emergencyrelation'], 'required'],
            [['notifications', 'emailsettings','listids','searchkeys'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'currency_mobile' => 'Currency Mobile'
        ];
    }
    ...
    {
        return $this->hasOne(Currency::className(), ['id' => 'currency_mobile']);
    }
}
