...
var socket = io.connect('https://developer.hitasoft.in:8085', {secure: true});
...
function constructData(align, data, type) {
	//console.log("constructData",data.chat_type);
	var outputData;
	if(align=='left')
	{
	if(data.chat_type == "audio"){
		outputData='<div class="claimleft"><div class="airfcfx-claimleftimgdiv claimleftimgdiv"><span class="airfcfx-user-icon profile_pict inlinedisplay" style="background-image:url('+data.userImg+');"></span></div><div class="airfcfx-claimrighttextdiv claimrighttextdiv"><span class="airfcfx-left-chat-arrow"></span><a href="'+data.profileURL+'">'+data.userName+'</a><span class="airfcfx-message-date padleft">'+data.date+'</span><br/><span class="mobmsgalgn"><audio controls><source src="'+data.newMessage+'" type="audio/mpeg"></audio></span></div></div><div class="clear"></div>';		
		
	}else if(data.chat_type == "gif"){
	outputData='<div class="claimleft"><div class="airfcfx-claimleftimgdiv claimleftimgdiv"><span class="airfcfx-user-icon profile_pict inlinedisplay" style="background-image:url('+data.userImg+');"></span></div><div class="airfcfx-claimrighttextdiv claimrighttextdiv"><span class="airfcfx-left-chat-arrow"></span><a href="'+data.profileURL+'">'+data.userName+'</a><span class="airfcfx-message-date padleft">'+data.date+'</span><br/><span class="mobmsgalgn"><img src="'+data.newMessage+'" alt="gif" style="width:80px;height:80px;"></span></div></div><div class="clear"></div>';	
