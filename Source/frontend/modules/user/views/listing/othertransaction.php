...
$this->title = Yii::t('app','Other Transactions');
?>
<?php
...
<div class="bg_gray1">
      ...
      ?>
        ...
        echo '
                ...
                <li role="presentation" class="active"><a class="airfcfx-tab-padding" href="'.$baseUrl.'/user/listing/othertransaction">'.Yii::t('app','Other Transaction').'</a></li>';
              ...
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="profile">
                    ...
                    "9" => "September", "10" => "October", "11" => "November", "12" => "December",
                            ...
                            ?>
                             <div class="selcet-listing">
                              <select class="payout-start-month" onchange="javascript:filterbytransaction('other');">
                            ...
                            ?>
                             <div class="selcet-listing">
                              <select class="payout-start-year" onchange="javascript:filterbytransaction('other');">
