      ...
      <li><a href="'.$baseUrl.'/deleteaccount">'.Yii::t('app','Delete Account').'</a></li>';
        ...
        <div class="airfcfx-panel panel panel-default">
              ...
              <ul class="nav nav-tabs review_tab" role="tablist">
				<?php
				echo '
                <li role="presentation" class="active"><a class="airfcfx-tab-padding" href="'.$baseUrl.'/user/listing/completedtransaction">'.Yii::t('app','Completed Transaction').'</a></li>
              ...
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="profile">
                    ...
                    "9" => "September", "10" => "October", "11" => "November", "12" => "December",
                            ...
                            ?>
                             <div class="selcet-listing">
                              <select class="payout-start-month" onchange="javascript:filterbytransaction('complete');">
                            ...
                            ?>
                             <div class="selcet-listing">
                              <select class="payout-start-year" onchange="javascript:filterbytransaction('complete');">
                      ...
                      //$datas = (object) $transactions;
											...
											foreach($transactions as $transaction)
											{
												...
												//$currency = $transaction->getCurrency()->where(['currencycode'=>$transaction->
                        ...
                        if(!empty($currency))
                          ...
                          $currency_symbol = "";
												...
												$viewId = 'completed*'.$transaction->id; 
