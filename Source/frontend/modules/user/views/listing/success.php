        ...
        <div class="col-xs-12 margin_top20 margin_bottom20">
        	<div class="col-sm-12">
                <div class="panel panel-default margin_top30">
          		...
          		<?php echo "<center class='payment-success'><p>Thanks for your reservation!</p>";
          echo "<p><span>Your payment was successful</span>.</p>";
					echo '<a class="btn margin_top20" href="'.$baseUrl.'/user/listing/trips">'.Yii::t('app','Show Trips').'</a>';  
