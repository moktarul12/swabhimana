...
<div class="profile_head wishlisr">
	<div class="container">    
        ...
        <li class="active"><a href="<?php echo $baseUrl.'/user/listing/mywishlists';?>"><?php echo Yii::t('app','Lists'); ?></a></li>
...
<div class="container">
	<div class="col-sm-12 no-hor-padding">
		...
		if(isset($totallists) && !empty($totallists))
		{
			$total_lists = 0;
			foreach($totallists as $list)
			{
  	...
  	<?php if($total_lists == 0) {?>
        ...
        <div class="col-xs-12 margin_top20 margin_bottom20">
                    ...
                    <a href="#" class="text-danger"><h4 class="margin_top0"><b><?php echo $firstname;?>'s <?=Yii::t('app','Lists')?></b></h4></a>
                    <p> <?=Yii::t('app','Lists')?>: <b><?php echo $total_lists;?></b></p>
                    </div> 
                   	<!--div class="col-sm-2">
                    <button class="btn btn_google pull-right " data-toggle="modal" data-target="#myModal">Create a New Lists</button>
                    </div-->
		...
		if(isset($lists) && !empty($lists))
		{
			foreach($lists as $list)
			{
				...
				echo '<div class="col-xs-12 col-sm-4  margin_bottom20 "> 
                  ...
                  <button class="min-blue-bg btn btn_wish pos_rel z_1">'.$wishcount.' '.Yii::t('app','Listings').'</button>         
                  </div>                  
                  </a>
				</div>';
				}
