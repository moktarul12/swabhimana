...
$express_URL = "https://connect.stripe.com/express/oauth/authorize?response_type=code&client_id=".$stripe_clientId."&scope=read_write&redirect_uri=".Yii::$app->urlManager->createAbsoluteUrl ("payoutpreference");
