...
namespace yii\conquer\i18n;

use yii\di\Instance;
use yii\conquer\i18n\models\I18nMessage;
use yii\i18n\MissingTranslationEvent;
use yii\caching\Cache;
use yii\conquer\i18n\models\I18nTranslator;
use yii\conquer\i18n\models\I18nTranslation;
...
class MessageSource extends \yii\i18n\MessageSource
{
    ...
    {
        parent::init();
        $this->translator = Instance::ensure($this->translator, 'yii\conquer\i18n\TranslatorInterface');
