							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									<p style='margin-bottom: 10px'>
										<?= $sender; ?> shared a below listing Please find below. 
									</p>
									<?php
									 $userurl = base64_encode($senderid."-".rand(0,999));
   									$usernameurl = Yii::$app->urlManager->createAbsoluteUrl ( '/profile/' . $userurl );
									?>
									<p>User : <a href="<?= $usernameurl; ?>" alt="Click To View Profile"><?= $sender; ?></a>- Airfinch Member</p>
									<p>Listing Name : <?= $listingname; ?></p>
									<p>Listing Property : <?= $listingproperty; ?></p>
									<p>Description : <?= $description; ?></p>
									<p style='margin-bottom: 10px'>
										Message:
										<?= $message; ?>
									</p>
									<p><a href="<?= $listurls; ?>" style="font-weight: bold; font-size: 18px;">View Home</a></p>
								</td>
							</tr>
							<tr>
								<td style="padding: 15px 0"  valign="top">
