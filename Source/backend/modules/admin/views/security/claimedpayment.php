...
$this->title = 'Claimed Payment';
$this->params['subtitle'] = Yii::t('app','Claimed Payment');
		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h2>'.Yii::t('app','Claimed Payment').'</h2>
			...
			[
				...
				'value' =>function ($model) {
					$baseUrl = Yii::$app->request->baseUrl;
                            ...
                            /*if($endtime<=$totime)
                            $button='<input type="button" value="Approve" class="btn btn-success" onclick="approve_guest_security('.$reservation->id.')">';
                            else
