...
$this->title = 'Listing Reports';
$this->params['subtitle'] = ''. Yii::t('app','Reports by Listing').'';
...
<div class="lists-view">
    ...
    <p>
        <?php echo Html::a(Yii::t('app', 'Back'), ['/admin/listreport/index'], ['class' => 'btn btn-primary']) ?>
    ...
    <?= DetailView::widget([
		...
		[
			'label' =>  ($model->reporterid != 0) ? Yii::t('app', 'Reporter Name') : Yii::t('app', 'Listing Name') ,
