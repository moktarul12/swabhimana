		...
		<div class="panel-body">
			...
			$form = ActiveForm::begin([
				'options' => ['enctype'=>'multipart/form-data','class'=>'form-horizontal row-border'],
				 	...
				 	$cancelurl = Yii::$app->urlManager->createAbsoluteUrl("/admin/buttonslider/index");
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							<button class="btn-primary btn" onclick="return validatebutton();" id="submitbtn">'.Yii::t('app','Submit').'</button>
						</div>
					</div>
				</div>';				
			ActiveForm::end();
