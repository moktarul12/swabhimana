...
<!-- 			data-action-expand='' data-action-colorpicker=''></div> -->
	...
	<div class="panel-body">
		<div class="reservations-view">
			...
			'.Yii::t('app','Booking Duration:').' '.date('M d-Y',$model->fromdate).'<b> '.Yii::t('app','To').' </b>'.date('Md-Y',$model->todate);
			...
			echo '<table class="tablesorter table table-striped table-bordered table-condensed">
                <thead>
                    <tr>
                        ...
                        <th>'.Yii::t('app','Number of days').'</th>
                        <th>'.Yii::t('app','Price per night').'</th>
			...
			echo '<div class="detaildiv">
                <div class="clear">
                    <div class="leftdivs">'.$model->pricepernight.' x '.$model->totaldays.'</div>
